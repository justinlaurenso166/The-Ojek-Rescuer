...
public class Extinguisher : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Debug.DrawRay(raycastOrigin.position, raycastOrigin.forward * 100f, IsRaycastingSomething(out RaycastHit hit) ? Color.green : Color.red);

        if(Physics.Raycast(raycastOrigin.position, raycastOrigin.forward, out hit, 100f)){
